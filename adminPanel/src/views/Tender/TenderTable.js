  ...
  return (
    <div>
      ...
      {/* <ConfirmationDialog
        ...
        title="Do you want to delete this Tender?"
        body="You can not undo this operation after proceeding."
        handleOk={acceptConfirmation}
        handleCancel={rejectConfirmation}
      />
      <Toast severity={severity} responseMsg={responseMsg} openSnackBar={openSnackBar} /> */}
...
//         console.log("Deleting tender with id:", body.id); // Debugging line
...
//         return (
//             <span>
//                 <span style={{ margin: "5px" }}><i onClick={() => editTender(rowData)} className="pi pi-pencil "></i></span>
//                 <i onClick={() => deleteTender(rowData)} className="pi pi-trash"></i>
//             </span>
//         );
//     };
